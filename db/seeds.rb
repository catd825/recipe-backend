...
recipe1 = Recipe.create!(title: 'pasta', description: 'basic pasta recipe', ingredients: '1 lb of pasta',
                         instructions: 'boi l water, add pasta, cook for 8 min, then drain, add toppings, and serve', recipe_creator_id: user3.id)
...
recipe3 = Recipe.create!(title: 'sauce', description: 'best marinara!',
                         ingredients: 'canned tomato, olive oil, oregano', instructions: 'simmer for hours!', recipe_creator_id: user3.id)
recipe4 = Recipe.create!(title: 'pasta al limone', description: '"easy and delicious!"',
                         ingredients: 'pasta lemon cheese', instructions: 'boil pasta add lemon and cheese', recipe_creator_id: user2.id)
